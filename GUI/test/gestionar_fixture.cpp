...
//        empataron
        ...
        if(!(ui->checkBox_10->isChecked() || ui->checkBox_11->isChecked())){
            ...
            if(maxset == 1){
                  ...
                  if(setA1  == -1 || setB1 == -1 || setA2 == -1 || setB2 == -1 || setA3 == -1 || setB3 == -1 ){
                  ...
                  if(setA1 == -1 || setB1 == -1 || setA2 == -1 || setB2 == -1 || setA3 == -1 || setB3 == -1 ||
                   setA4 == -1 || setB4 == -1 || setA5 == -1 || setB5 == -1 )
                  {
                      errFlag = true;
                  }
                  else if(!empate && ( sumA == sumB || setA1 == setB1 || setA2 == setB2 || setA3 == setB3 ||
                  ...
                  if(setA1 == -1 || setB1 == -1 || setA2 == -1 || setB2 == -1 || setA3 == -1 || setB3 == -1 ||
                   setA4 == -1 || setB4 == -1 || setA5 == -1 || setB5 == -1 || setA6 == -1 || setB6 == -1 ||
                   setA7 == -1 || setB7 == -1 )
                  {
                      errFlag = true;
                  }
                  ...
                  if(setA1 == -1 || setB1 == -1 || setA2 == -1 || setB2 == -1 || setA3 == -1 || setB3 == -1 ||
                   setA4 == -1 || setB4 == -1 || setA5 == -1 || setB5 == -1 || setA6 == -1 || setB6 == -1 ||
                   setA7 == -1 || setB7 == -1 || setA8 == -1 || setB8 == -1 || setA9 == -1 || setB9 == -1)
                  {
                      errFlag = true;
                  }
                  else if(!empate && (sumA == sumB || setA1 == setB1 || setA2 == setB2 || setA3 == setB3 ||
